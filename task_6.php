                            ...
                            <?php if ($v['banned']) : ?>
                                <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                    ...
                                    <div class="ml-2 mr-3">
                                        ...
                                        <a href="<?php echo $v['link_twitter'] ?>" class="text-info fs-sm"
                                           target="_blank"><?php echo $v['text_link'] ?></a> -
                                        <a href="<?php echo $v['text_wrap_bootstrap'] ?>" class="text-info fs-sm"
                                           target="_blank" title="<?php echo $v['title_contact'] ?>"><i
                            ...
                            <?php else : ?>
                                <div class="banned rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                    ...
                                    <div class="ml-2 mr-3">
                                        ...
                                        -
                                        <a href="https://wrapbootstrap.com/user/lodev09" class="text-info fs-sm"
                                           target="_blank" title="Contact Jovanni"><i class="fal fa-envelope"></i></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
